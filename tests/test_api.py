"""Tests for PremierTestLL api."""
import asyncio

import aiohttp
from custom_components.premiertestll.api import (
    PremiertestllApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = PremiertestllApiClient("test", "test", async_get_clientsession(hass))
